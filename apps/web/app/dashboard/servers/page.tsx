...
export default function ServersPage() {
  return <DashboardShell title="Servers">
    ...
    <div className="card"><div className="list"><div className="list-row"><div><strong>No servers registered</strong><small>Register a server to receive its platform connection identity.</small></div><span className="badge warning">Offline</span></div></div><div style={{ marginTop: 18 }}><button className="btn primary">Register server</button></div></div>
